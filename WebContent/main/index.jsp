						...
						<div id="rev_slider_1_1" class="rev_slider fullwidthabanner" style="display:none;max-height:600px;height:600;">
							<ul>
								...
								<li data-transition="random" data-slotamount="7" data-masterspeed="300" >
									<!-- MAIN IMAGE -->				
									<img src="../lib/images/main/1.PNG"  alt="image-1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">				
									<!-- LAYERS -->				
									...
									data-endspeed="300"
									style="z-index: 2">
										<img src="../lib/images/main/2.PNG" alt=""></div>
								...
								<li data-transition="random" data-slotamount="7" data-masterspeed="300" >
									<!-- MAIN IMAGE -->				
									<img src="../lib/images/main/3.PNG"  alt="image-2"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">				
									<!-- LAYERS -->				
									...
									data-endspeed="300"
									style="z-index: 5">
										<img src="../lib/images/main/4.PNG" alt="" data-ww="13" data-hh="9"></div>
									...
									data-endspeed="300"
									style="z-index: 7">
										<img src="../lib/images/main/5.PNG" alt="" data-ww="13" data-hh="9"></div>
