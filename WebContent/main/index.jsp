						...
						<div id="rev_slider_1_1" class="rev_slider fullwidthabanner" style="display:none;">
							<ul>
								...
								<li data-transition="random" data-slotamount="7" data-masterspeed="300" >
									...
									data-endspeed="300"
									style="z-index: 5">
										매일 따끈따끈한 구운 빵을 사용합니다.
										<br>				
										6종류의 빵을 선택해서 샌드위치를 먹자!
										</div>
								</li>
								<!-- SLIDE  -->				
								<li data-transition="random" data-slotamount="7" data-masterspeed="300" >
									<!-- MAIN IMAGE -->				
									<img src="../lib/images/main/11.PNG"  alt="11"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">				
									
								</li>
								<!-- SLIDE  -->				
								<li data-transition="random" data-slotamount="7" data-masterspeed="300" >
									<!-- MAIN IMAGE -->				
									<img src="../lib/images/main/5.PNG"  alt="5"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">				
								...
								<li data-transition="random" data-slotamount="7" data-masterspeed="300" >
									<!-- MAIN IMAGE -->				
									<img src="../lib/images/main/7.PNG"  alt="7"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">				
								</li>
								<li data-transition="random" data-slotamount="7" data-masterspeed="300" >
									<!-- MAIN IMAGE -->				
