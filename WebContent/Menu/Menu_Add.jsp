		...
		<div class="container">
			<div class="col-md-12">
				<marquee behavior="alternate" scrollAmount="5">
					<font color="#009900" size="3">Myway 메뉴 등록</font>
				</marquee>
				<br>
				<br>
				...
				<form id="Menu_Saves" onsubmit="return false;" method="post"
					...
					<table border="1" cellspacing="0" cellpadding="10">
						...
						<tr>
							...
							<td valign="top" align=left><textarea name="detail"></textarea>
							</td>
						</tr>
						<tr>
